...
<pre style="position: relative;"><strong>Input:</strong> arr = ["d","b","c","b","c","a"], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> arr = ["aaa","aa","a"], k = 1
...
<pre style="position: relative;"><strong>Input:</strong> arr = ["a","b","a"], k = 3
