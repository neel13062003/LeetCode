        // bricks means adding steps and ladders can we use only given time
        //mean heap = we swap lowest value when we want to swap bricks and ladders
        //priority queeu
        //space = O(L) lather & Space complexity= Nlog(L)
